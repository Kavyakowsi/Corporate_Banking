pipeline {
    ...
    environment {
        ...
        PLAYWRIGHT_DIR = 'C:/Users/kavya.s1/Downloads/corporate-banking-rbc-solution/corporate-banking-demo/src/test/java/com/example/corporatebanking/ExampleTest.java'
    }
